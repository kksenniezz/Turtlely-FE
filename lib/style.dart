...
class TText {
  static const logo = TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: TColor.darkGreen);
  static const title = TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: TColor.black);
  static const body = TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: TColor.black);
  static const button = TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: TColor.white);
  static const caption = TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: TColor.gray);
