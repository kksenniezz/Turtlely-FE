...
class _ExerciseViewState extends State<ExerciseView> {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          // 저장한 영상 화면으로 이동 후 돌아왔을 때 목록 새로고침
  ...
  Future<void> _toggleBookmark(Map<String, dynamic> v) async {
    ...
    final newBookmarkState = await ApiService().toggleBookmark(videoId);

    if (newBookmarkState != null && mounted) {
      setState(() {
        v['isBookmarked'] = newBookmarkState;
        v['is_bookmarked'] = newBookmarkState;
      });
    }
  }
