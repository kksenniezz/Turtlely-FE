...
class _HomeViewContentState extends State<HomeViewContent> {
  ...
  double lastAccY        = 0.0;
  double lastAccZ        = 0.0;
  double lastEstimatedCva = 0.0; // 추가!
  ...
  void parseSensorData(String data) {
    ...
    if (cleanData.startsWith("CALIB_DONE")) {
      ...
      if (parts.length >= 3) {
        ...
        debugPrint("📊 캘리브레이션 평균값 | accX: $avgX, accY: $avgY, accZ: $avgZ");
              ...
              Expanded(
                child: Center(
                  child: isCalibrating
                      ...
                      : Image.asset(
                          isBadPosture ? 'assets/bad_turtle.png' : 'assets/normal_turtle.png',
                          width: 280,
                          errorBuilder: (_, __, ___) => Text(
                            isBadPosture ? "🐢 자세 펴세요!" : "🐢 바른 자세",
